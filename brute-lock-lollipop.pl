...
sub islockscreen
{
    ...
    return ($package eq "com.android.systemui" && $class eq "android.widget.FrameLayout");
}

print "Starting bruteforce\n";
my $start=0;
if (defined $ARGV[$0]) { $start=$ARGV[$0]; }
for (my $i=$ARGV[$0]; $i<10000;$i+=5)
{
